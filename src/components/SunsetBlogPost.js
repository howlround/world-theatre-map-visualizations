...
export default function SunsetBlogPost() {
  return (
    <div class="post-text">
      ...
      <p>If you are interested in reanimating the project and adapting the existing data, the entire project lives permanently on <a href="https://github.com/howlround/worldtheatremap" target="_blank" aria-label="GitHub (link opens in a new window)">GitHub</a>. Email map@howlround.com if you would like further information.</p>
    </div>
  );
}
